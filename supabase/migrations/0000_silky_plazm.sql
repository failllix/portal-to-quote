CREATE TYPE "public"."file_status" AS ENUM('in_process', 'done', 'failed');--> statement-breakpoint
...
CREATE TABLE "files" (
	...
	"status" "file_status" DEFAULT 'in_process' NOT NULL
);
...
CREATE TABLE "quotes" (
	...
	"material_id" text,
	"material_name" text,
	"material_price_factor" numeric(10, 4),
	"quantity" integer,
